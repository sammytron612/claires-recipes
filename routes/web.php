...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:isAdmin')->group(function () {
        ...
        Route::get('/admin/recipes', [EditController::class, 'recipeIndex'])->name('admin.recipe-index');
        Route::get('/admin/recipe/{id}/edit', [EditController::class, 'edit'])->name('admin.recipe-edit');
