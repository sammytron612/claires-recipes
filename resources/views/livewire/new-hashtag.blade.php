                ...
                <form enctype="multipart/form-data" wire:submit.prevent="storeHashtag">
                    ...
                    <div class="bg-white px-6 py-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input wire:model.blur="image" type="file" class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('image') border-red-500 @enderror" id="photo">
