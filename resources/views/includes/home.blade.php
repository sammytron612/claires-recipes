            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item @if($loop->first)  {{ 'active' }} @endif" >
                ...
                <div class="carousel-caption d-flex h-100 align-items-center justify-content-center">
                    ...
                    <h3 style="font-family: 'Pacifico', cursive; background: rgba(204, 204, 204, 0.8);" class="border border-dark text-dark p-5">{{ $recipe->title }}</h3>
                </div>
              </div>
              @endforeach
            </div>
...
<section>
    <div class="container p-5 bg-white">
        ...
        <div class="row mt-5">
            <h2>Our top 10</h2>
            <div class="mt-2 row row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
