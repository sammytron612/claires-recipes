<div class="bg-white row row-cols-1 row-cols-md-2 align-items-center py-2">
    <div class="d-flex justify-content-center col"><img style="height:170px" class="img-fluid" src="{{ asset('storage/claires-recipes.png') }}" alt="Claires Site Logo"></div>
    <div class="d-flex ml-2 ml-sm-0 justify-content-center col"></div>
</div>
