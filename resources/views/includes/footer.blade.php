<footer class="mt-auto">
    <div class="w-full bg-custom py-3">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between py-3">
                ...
                <div class="flex space-x-4">
                    ...
                    <div class="bg-circle-outline">
                        <a href="https://www.facebook.com/" class="text-white hover:text-gray-200 transition-colors p-2 block" aria-label="Facebook">
                    ...
                    <!-- Twitter Icon -->
                    <div class="bg-circle-outline">
                        <a href="https://twitter.com/" class="text-white hover:text-gray-200 transition-colors p-2 block" aria-label="Twitter">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Pinterest Icon (fixed the mismatch) -->
                    <div class="bg-circle-outline">
                        <a href="https://www.pinterest.com/" class="text-white hover:text-gray-200 transition-colors p-2 block" aria-label="Pinterest">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
