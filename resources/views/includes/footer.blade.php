...
<div class="container-fluid bg-custom py-3">
    <div class="container">
      <div class="row py-3">
        <div class="col-md-9">
          <p class="text-white">© Kevin Wilson 2021</p>

            <a class="nav-link text-white" href="{{ url('home/privacy') }}">
                Privacy notice
            </a>
        ...
        <div class="col-md-3">
          <div class="d-inline-block">
            <div class="bg-circle-outline d-inline-block">
              <a href="https://www.facebook.com/" class="text-white"><i class="fab fa-2x fa-facebook"></i>
		</a>
            </div>
