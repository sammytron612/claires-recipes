@extends('layouts.app', ['noFollow' => true, 'index' => true, 'title' => 'Claires Recipes - Ingredients', 'description' => "Claires Recipes, tasty recipes tried and tested for everyone"])
